...
def explicit_decision(row, source_rows, page_cache):
    ...
    phase_a2 = {
      ...
      'geoshape-nrct-poi:260000055300': ('http://shoboji.or.jp/', 'The official temple page explicitly identifies Shoboji in Yawata, Kyoto. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
      'geoshape-nrct-poi:270000034800': ('https://www.hatidai-jinja.com/', 'The official shrine page explicitly identifies Hachidai Shrine in Ichijoji, Sakyo-ku, Kyoto. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
      'geoshape-nrct-poi:270000038800': ('https://kitashirakawa-tenshingu.jp/', 'The official shrine page explicitly identifies Kitashirakawa Tenshingu in Kyoto. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
      'geoshape-nrct-poi:270000051000': ('https://www.shogoin.or.jp/', 'The official temple page explicitly identifies Shogoin Monzeki in Kyoto. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
      'geoshape-nrct-poi:270000067500': ('https://amanosan-kongoji.jp/', 'The official temple page identifies Amanosan Kongoji in Osaka and cannot establish the frozen Kyoto candidate.'),
      'geoshape-nrct-poi:270000088200': ('https://souda-kyoto.jp/guide/spot/houkouji.html', 'The Kyoto travel page identifies Hokoji in Chayacho, Higashiyama-ku, Kyoto. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
      'geoshape-nrct-poi:270000089000': ('http://toyokuni-kyoto.jp/', 'The official shrine page explicitly identifies Toyokuni Shrine in Chayacho, Higashiyama-ku, Kyoto. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
      'geoshape-nrct-poi:280000022200': ('https://www.minasejingu.jp/', 'The official shrine page explicitly identifies Minase Jingu in Shimamoto, Osaka. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
      'geoshape-nrct-poi:280000044700': ('http://sojiji.or.jp/', 'The official temple page identifies Sojiji with the same Ibaraki, Osaka target locality. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
      'geoshape-nrct-poi:280000079900': ('https://www.kureha-shrine.com/', 'The official shrine page identifies Kureha Shrine in Ikeda, Osaka. It confirms identity, but no independently calibrated 43D score, Visit Profile, or static Access fact is added.'),
    }
    if key in phase_a2:
        url, reason = phase_a2[key]; page = pages[url]; text = (page_cache/page['fetch']['textPath']).read_text(encoding='utf8')
        confirmed = key in {'geoshape-nrct-poi:200000076900','geoshape-nrct-poi:200000136900','geoshape-nrct-poi:210000293600','geoshape-nrct-poi:210000307500','geoshape-nrct-poi:220000156200','geoshape-nrct-poi:230000055800','geoshape-nrct-poi:240000108800','geoshape-nrct-poi:250000042800','geoshape-nrct-poi:260000013200','geoshape-nrct-poi:260000019500','geoshape-nrct-poi:260000029300','geoshape-nrct-poi:260000033800','geoshape-nrct-poi:260000055300','geoshape-nrct-poi:270000034800','geoshape-nrct-poi:270000038800','geoshape-nrct-poi:270000051000','geoshape-nrct-poi:270000088200','geoshape-nrct-poi:270000089000','geoshape-nrct-poi:280000022200','geoshape-nrct-poi:280000044700','geoshape-nrct-poi:280000079900'}
