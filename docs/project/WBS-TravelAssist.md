...
| TASK-WBS-4.20-B | 4.20（规划4.21–4.24） | B | 待审查（仅契约设计；自动合并不等于验收） | #201 | `docs/tasks/TASK-WBS-4.20-b-travelassist-engine-contract.md` | `feature/b-travelassist-engine-contract` | `214d035`（契约设计） | [#237](https://github.com/kanzakimy0/TravelAssist/pull/237) 由仓库自动化提前合并；review-gate Draft PR 待创建 |
