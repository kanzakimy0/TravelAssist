...
- WBS 9.1 更新为 **待审查**；PR/Issue 保持 Review，不自动合并。完整基线：`docs/qa/test-baseline.md`；Result：`docs/tasks/RESULT-TASK-035-a-test-baseline-freeze.md`。
...
| TASK-035-A | 9.1 | A / Shared QA | 待审查（测试基线已冻结；2 项既有 Asset failure 明示） | #265 | `docs/tasks/TASK-035-a-test-baseline-freeze.md` / `docs/tasks/RESULT-TASK-035-a-test-baseline-freeze.md` | `codex/a-test-baseline-freeze` | PENDING | PENDING（Draft，不自动合并） |
