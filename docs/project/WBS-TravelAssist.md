...
| WBS-5.20-B | 5.20 | B | 待审查（实现完成，待用户验收） | #146 | `docs/tasks/TASK-WBS-5.20-b-personal-center-responsive-states.md` | `feature/b-account-wbs-5-20-personal-center-responsive-states` | PENDING | PENDING |
...
| 5.20   | 个人中心 Loading / Empty / Error / Responsive | B      | P1     | 1.29,5.1 | 待审查 |
