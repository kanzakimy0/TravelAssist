...
| TASK-043-A | 2.18 | A | 待审查（Canonical Master Code Registry Governance Candidate；50/50 Region allocation；不自动完成 4.48） | #311 Open | `docs/tasks/TASK-043-a-master-code-registry.md`（Task publication branch） / `docs/tasks/RESULT-TASK-043-a-master-code-registry.md` | `codex/a-master-code-registry` | 待最终提交 | Draft PR 待创建 → `develop` |
...
| 2.18 | Canonical Master Code Registry / Allocation Governance | A | P0 | 2.6,2.7,0.9 | 待审查（TASK-043-A；Issue #311；Governance Candidate；50/50 Region allocation） |
