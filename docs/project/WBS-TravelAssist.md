...
| WBS-5.9-B | 5.9 | B | 待审查（待用户验收） | #138 | `docs/tasks/TASK-WBS-5.9-b-dining-accommodation-budget-ui.md` | `feature/b-account-wbs-5-9-dining-accommodation-budget-ui` | PENDING | PENDING |
...
| 5.9    | 餐饮 / 住宿 / 预算偏好 UI                     | B      | P1     | 5.5      | 待审查 |
