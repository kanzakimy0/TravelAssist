...
| WBS-5.2-B | 5.2 | B | 待审查 | #50 | `docs/tasks/TASK-WBS-5.2-b-avatar-menu-navigation.md` | `feature/b-account-wbs-5-2-avatar-menu` | PENDING | PENDING |
...
| 5.2    | 头像菜单与个人中心跳转目标                    | B      | P0     | 5.1      | 待审查 |
