...
| WBS-5.20-B-FOLLOWUP | 5.20（completed-task UI follow-up；关联 5.4 / 5.5 / 5.6 / 5.10） | B | 待审查（用户逐页视觉验收通过；待合并） | #149 | `docs/tasks/TASK-WBS-5.20-b-personal-center-concept-alignment-followup.md` | `fix/b-wbs-5-20-personal-center-concept-alignment` | `ea10d79`（实现） | [#150](https://github.com/kanzakimy0/TravelAssist/pull/150) Draft → develop |
