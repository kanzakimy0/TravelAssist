...
| TASK-012-A | 1.5 / 1.6 / 1.7 / 1.14 / 4.1 / 4.8 / 4.14 / 4.15（v0.5 UI 子集） | A | 阻塞（实现已交付；1180px 规范冲突待确认） | #111 | `docs/tasks/TASK-012-a-planner-v05-visual-secondary-panels.md` | `feature/a-planner-v05-visual-secondary-panels` | PENDING | PENDING；基线 `4c1d9bb`，冻结推荐方案，不自动合并 |
