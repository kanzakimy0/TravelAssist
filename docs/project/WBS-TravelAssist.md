...
| WBS-5.8-B | 5.8 | B | 进行中 | #128 | `docs/tasks/TASK-WBS-5.8-b-attraction-activity-preference-ui.md` | `feature/b-account-wbs-5-8-attraction-activity-preference-ui` | PENDING | PENDING |
