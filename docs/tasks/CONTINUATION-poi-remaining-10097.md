...
The user further requested discovery by place name, prefecture and category, and a persistent pending-review list for repeated queries or human review. Search attempts, identity decisions and supported attribute reviews must be reported separately.
